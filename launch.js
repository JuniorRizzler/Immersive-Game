...
(function() {
  ...
  s = [['controlType', ['KEYBOARD', 'TOUCH'], defaultControls, defaultControls, 'Controls: '], ['quality', ['LOW', 'MID', 'HIGH', 'VERY HIGH'], 3, 3, 'Quality: '], ['hud', ['OFF', 'ON'], 1, 1, 'HUD: '], ['godmode', ['OFF', 'ON'], 0, 1, 'Godmode: ']];
  ...
  if (!hasWebGL()) {
    ...
    $('start').onclick = function() {
      ...
      return $('step-2').style.backgroundImage = "none";
    };
  }
